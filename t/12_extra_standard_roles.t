...
my $dump_1 = $d_1.ddt: :get, :title<title>, :!color, "nl1\nnl2\nnl3" ;
...
my $dump_4 = $d_4.ddt: :get, :!color, my_grammar.parse("fuu \n\nbart baz x") ;
like($dump_4, /0\.\.15/, 'Grammar Match')  ;
is $dump_4.lines.elems, 15, 'Grammar Match lines' or diag get_dump $dump_4 ;

my $dump_4_2 = $d_4.ddt: :get, :!color, 'ababa' ~~ m:g/a(b)/, display_perl_address => True ;
