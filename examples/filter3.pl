...
ddt $s, :title<element filter>, :nl, elements_filters => (&remove_tomatoe_container_filter_1,) ;
ddt $s, :title<keep tomatoe butmake it empty>, :nl, elements_filters => (&remove_tomatoe_container_filter_2,) ;
