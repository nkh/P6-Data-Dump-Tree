...
Will set a default glyph color cycle.
	...
	dump(@s, :color_glyphs) ; #uses < glyph_0 glyph_1 glyph_2 glyph_3 >
...
You can also define your own cycle with B<@kb_colors>: 
	...
	dump(@s, :color_glyphs, glyph_colors => < glyph_0 glyph_1 >) ;
...
Will set a default key and binding color cycle.
	...
	# used color 'kb_1', 'kb_2' ... and cycles
...
This module will mature with time, and with your suggestions, it is intended to
replace my P5 Data::TreeDumper module for P6.
