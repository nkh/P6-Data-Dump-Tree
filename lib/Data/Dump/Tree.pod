...
=head2 sub dump($structure_to_dump, named_argument, ...)

'say's the dump of the data structure

=head2 sub get_dump($structure_to_dump, named_argument, ...)

Returns a string containing the dump of the data structure

=head2 sub get_dump_lines($structure_to_dump, named_argument, ...)

Returns an array containing the dump of the data structure

=head2 method dump($structure_to_dump, named_argument, ...)

'say's the dump of the data structure

=head2 method  get_dump($structure_to_dump, named_argument, ...)

Returns a string containing the dump of the data structure

=head2 method get_dump_lines($structure_to_dump, named_argument, ...)
