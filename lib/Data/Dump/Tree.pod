...
=item can be used "visit" a data structure and call callbacks you define
...
the element will not be displayed at all.
	...
	sub my_filter(\r, Tomatoe $s, DDT_HEADER, $, $)
	{
...
variable.
	...
	$dumper does DDTR::MatchDetails ;
	
	 "'    [passwords]\n        jack=password1\n '(+74) [0..114|".Match @1 
	   |- section => "'    [passwords]\n        jack=password1\n '(+29) [0..69|".Match @2 
	   |  |- header => "'    [passwords]\n' [0..16|".Match @3 
	   |  |  `- 0 => "'passwords' [5..14|".Match @4 
	   |  |- kvpair => "'        jack=password1\n' [16..39|".Match @5 
	   |  |  |- identifier => "'jack' [24..28|".Match @6 
	   |  |  |- key => "'jack' [24..28|".Match @7 = @6 
	   |  |  |- identifier => "'password1' [29..38|".Match @8 
	   |  |  `- value => "'password1' [29..38|".Match @9 = @8 
	   |  `- kvpair => "'        joy=muchmoresecure123\n' [39..69|".Match @10 
	   |     |- identifier => "'joy' [47..50|".Match @11 
	   ...
